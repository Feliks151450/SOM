#This code was modified by H.Hayashida to reduce the computing time
#20190305: updated the code to adjust intensity_cumulative if MHW spans multiple years
#similar to total_days. Taking the ratio of the two gives intensity_mean
#To find out what has been removed, use "diff" command with the original code.
